...
ID="$(basename "${RB_FILE%.rb}" | sed -r "s/(^|[^a-z])([a-z])/\U\2/g")" # HoneyVent
BIN=honeyvent
...
function get_asset_url() {
  ...
  echo "https://github.com/honeycombio/honeyvent/releases/download/v${VSN}/honeyvent-${OS}-${ARCH}"
}
